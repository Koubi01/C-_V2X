...
tools: [vscode, execute, read, agent, edit, search, web, browser, vscode.mermaid-chat-features/renderMermaidDiagram, ms-azuretools.vscode-containers/containerToolsConfig, ms-python.python/getPythonEnvironmentInfo, ms-python.python/getPythonExecutableCommand, ms-python.python/installPythonPackage, ms-python.python/configurePythonEnvironment, todo]
---

## Instruction
Always read the .github\copilot-instructions.md, .github\instructions\client-mudblazor-wasm.instructions.md, .github\instructions\server-interface-first-data.instructions.md and .github\instructions\server-minimal-api.instructions.md file in the repository before taking any action. Follow the instructions and constraints specified in that file carefully. If you have any questions about the instructions, ask for clarification before proceeding.
