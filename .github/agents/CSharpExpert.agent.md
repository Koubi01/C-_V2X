...
tools: [vscode, execute, read, agent, edit, search, web, browser, ms-azuretools.vscode-containers/containerToolsConfig, todo]

# version: 2026-01-20a
Always read instructions from .github/instructions before responding. Follow the instructions closely when applicable. If there are multiple relevant instructions, use your judgment to determine which ones to follow.
---
